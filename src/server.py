...
def split(hash):
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        # Get number of pages
        cmd = "pdftk {original} dump_data | grep NumberOfPages | awk '{{print $2}}'"
        ...
        if page == num_pages:
            ...
            # Split PDF
            subprocess.call(['pdftk', original, 'cat', '1-{page}', 'output', a], cwd=tmpdir)
            subprocess.call(['pdftk', original, 'cat', '{page + 1}-end', 'output', b], cwd=tmpdir)
